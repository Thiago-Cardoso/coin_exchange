...
(function() {
  $(document).ready(function() {
    ...
    $('#currency, #currency_destination, #quantity').change(function() {
      return handle();
    });
    ...
    handle = function() {
      return $.ajax('/exchange', {
        ...
        beforeSend: function() {
          ...
          return $('#quantity').attr('disabled', 'disabled');
        },
        data: {
        ...
        success: function(data, text, jqXHR) {
          ...
          if (currency !== "") {
            ...
            $('#loading').hide();
            return $('#quantity').removeAttr('disabled');
          }
        }
      });
    };
    return $('#invert_currency').click(function() {
      var currency, currency_destination;
      currency = $("#currency option:selected").text();
      currency_destination = $("#currency_destination option:selected").text();
